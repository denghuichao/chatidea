...
import com.github.denghuichao.chatcode.settings.ChatCodeSettingsPanel;
...
public class SettingAction extends DumbAwareAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ShowSettingsUtil.getInstance().showSettingsDialog(e.getProject(), ChatCodeSettingsPanel.class);
    }
}
